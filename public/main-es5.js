...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        var t1 = animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({});
        t1
            .add({
            targets: this.title,
        ...
        t1.finished.then(function () {
            ...
            _this.logo.style.opacity = "1";
        })
            .then(function () {
            _this.title.style.opacity = "0";
            // this.title.style.display = "none"
        });
    };
    HomeComponent.prototype.collectVariables = function () {
    ...
    HomeComponent.prototype.setCenter = function (_element, _parent) {
        var verticalCenter = (window.innerHeight / 2) - (_element.clientHeight / 2);
    ...
    HomeComponent.prototype.setBottom = function (_element) {
        var verticalSpot = (window.innerHeight) - (_element.clientHeight * 1.75);
        _element.style.marginTop = verticalSpot.toString() + 'px';
    };
    HomeComponent.prototype.columnAnimation = function () {
        var _this = this;
        var animation = animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_2__["default"].timeline({
            delay: 1500
        })
            .add({
            targets: this.logo,
...
var CreateformComponent = /** @class */ (function () {
    ...
    CreateformComponent.prototype.onSelect = function (_el, _item, _itemArray) {
        var selected = false;
        var visaId = document.getElementById(_item);
        var success = "#28a745";
        var normal = "#f2f2f2";
    ...
    CreateformComponent.prototype.dataExists = function (_data) {
        if (_data) {
            return true;
        }
        else {
    ...
    CreateformComponent.prototype.dataHasCorrectLength = function (_data, _length) {
    ...
    CreateformComponent.prototype.isvalid = function (_data, _length) {
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.collectVariables = function () {
    };
    NavbarComponent.prototype.showCreate = function () {
        //TODO
    };
    NavbarComponent.prototype.showDatabase = function () {
        //TODO
    };
